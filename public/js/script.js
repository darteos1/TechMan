  ...
  function mostrarSenha(){
    document.getElementById('input-2').type == 'password' ? document.getElementById('input-2').type = 'text' : document.getElementById('input-2').type = 'password'
